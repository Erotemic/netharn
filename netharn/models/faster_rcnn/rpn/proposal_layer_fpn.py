...
import numpy as np
from netharn.models.faster_rcnn.rpn.generate_anchors import generate_anchors_all_pyramids
from netharn.models.faster_rcnn.rpn.bbox_transform import bbox_transform_inv, clip_boxes
from netharn.models.faster_rcnn.utils.config import cfg  # TODO: use non-global cfgs
...
class _ProposalLayer_FPN(nn.Module):
    ...
    def forward(self, input):
        ...
        anchors = anchors.view(1, num_anchors, 4).expand(
        ...
        for i in range(batch_size):
            ...
            raise NotImplementedError('use netharn nms')
...
if __name__ == '__main__':
    """
    CommandLine:
        python -m netharn.models.faster_rcnn.rpn.proposal_layer_fpn all
    """
    import xdoctest
