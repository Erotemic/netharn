...
from netharn.models.faster_rcnn.rpn.rpn_fpn import _RPN_FPN  # NOQA
from netharn.models.faster_rcnn.roi_pooling.modules.roi_pool import _RoIPooling
from netharn.models.faster_rcnn.roi_crop.modules.roi_crop import _RoICrop
from netharn.models.faster_rcnn.roi_align.modules.roi_align import RoIAlignAvg
from netharn.models.faster_rcnn.rpn.proposal_target_layer import _ProposalTargetLayer
# from .utils.net_utils import _smooth_l1_loss, _crop_pool_layer, _affine_grid_gen, _affine_theta
from netharn.models.faster_rcnn.utils.net_utils import _smooth_l1_loss

# TODO: don't use global config
...
class FPN(nn.Module):
    ...
    CommandLine:
        xdoctest ~/code/netharn/netharn/models/faster_rcnn/fpn/fpn.py FPN

    Example:
        >>> from netharn.models.faster_rcnn.fpn.fpn import *
        >>> classes = ['foo', 'bar']
        >>> class_agnostic = True
        >>> self = FPN(classes, class_agnostic)
...
_FPN = FPN  # NOQA backwards compat
