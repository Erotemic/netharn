...
from netharn.models.faster_rcnn.fpn.fpn import _FPN
...
class resnet(_FPN):
    ...
    def _init_modules(self):
        ...
        self.RCNN_roi_feat_ds = nn.Conv2d(
            256, 256, kernel_size=3, stride=2, padding=1)

        self.RCNN_top = nn.Sequential(
            nn.Conv2d(256, 1024, kernel_size=cfg.POOLING_SIZE,
                      stride=cfg.POOLING_SIZE, padding=0),
            nn.ReLU(True),
