...
class _AnchorTargetLayer_FPN(nn.Module):
    ...
    def forward(self, input):
        ...
        from netharn.models.faster_rcnn.rpn.generate_anchors import bbox_overlaps_batch
...
def _compute_targets_batch(ex_rois, gt_rois):
    ...
    from netharn.models.faster_rcnn.rpn.generate_anchors import bbox_transform_batch
