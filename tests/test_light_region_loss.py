...
def test_tensor_brambox_compat_ground_truth_encoding():
    ...
    _ret_ten = self._build_targets_tensor(pred_boxes, pred_confs, target_tensor, nH, nW)
    _ret_box = self._build_targets_brambox(pred_boxes, pred_confs, target_brambox, nH, nW)
